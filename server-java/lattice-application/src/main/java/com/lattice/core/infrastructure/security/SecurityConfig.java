...
import com.lattice.core.infrastructure.config.WebCorsProperties;
...
public class SecurityConfig {
    ...
    public SecurityConfig(JwtAuthenticationFilter jwtAuthenticationFilter, WebCorsProperties corsProperties) {
